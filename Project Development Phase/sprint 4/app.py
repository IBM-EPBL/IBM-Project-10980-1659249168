...
import requests
API_KEY = "0dtBYagxf2bDQvEw6zSVwXg03oRZpA3uhNEIn5XsErsH"
...
def predict():
    if request.method == "POST":
        ...
        response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/4222a434-d5ed-4618-8641-96c021c213e3/predictions?version=2022-11-17', json=payload_scoring,
